...
The risk scoring system combines two components:
...
1. **meter_failure_risk.csv**: Full risk scores for all meters
   - Columns: `meter_id`, `cluster_id`, `anomaly_score`, `cluster_degradation`, `risk_percent`
...
- **High risk_percent (80-100)**: Meters with atypical behavior in high-degradation clusters
- **Medium risk_percent (40-80)**: Meters with moderate anomaly or in moderate-degradation clusters
- **Low risk_percent (0-40)**: Meters with typical behavior in low-degradation clusters

The top 10% highest-risk meters should be prioritized for inspection/maintenance.
